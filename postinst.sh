...
# fetchbridge-User dort nie einen eigenen Unterordner anlegen, und
# logging_setup._resolve_log_file_path()s FHS-Fallback (/var/log/fetchbridge/...)
# wuerde auf jeder frischen Installation stillschweigend nie greifen.
mkdir -p /var/log/fetchbridge
chown fetchbridge:fetchbridge /var/log/fetchbridge
