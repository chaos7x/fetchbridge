...
RUN mkdir -p /log /etc/fetchbridge/conf.d /srv/media-pipeline/recordings /srv/media-pipeline/incoming && chmod 1777 /log /srv/media-pipeline/recordings /srv/media-pipeline/incoming
